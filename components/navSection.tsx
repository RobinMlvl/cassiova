...
import logo2 from "../app/assets/Cassiovapetit.png";
...
export const Navbar5 = (props: Navbar5Props) => {
  ...
  let sourceImage = logo2.src;

  return (
    <nav className="flex w-full items-center justify-between border-b border-border-primary bg-background-primary lg:min-h-18 lg:px-[5%]">
      <div className="size-full lg:flex lg:items-center lg:justify-between">
        ...
        <div className="hidden lg:flex lg:gap-4" onClick={() => setIsOpen(true)}>
          {buttons.map((button, index) => (
...
export const Navbar5Defaults: Navbar5Props = {
  ...
  links: [
    { title: "How does it work ?", url: "#how" },
    { title: "Case of study", url: "#case" },
    { title: "Business tracker", url: "#track" },
    { title: "Testimonials", url: "#tes" },
    { title: "FAQ", url: "#faq" },
  ],
  buttons: [
    {
